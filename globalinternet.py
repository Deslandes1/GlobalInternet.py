# ====== FULL app.py (Lakay se Lakay - WITH GLOBAL SHIELD IN SIDEBAR) ======
# Lakay se Lakay - Haitian Social Media Platform
# Lead Developer: Gesner Deslandes (Python Developer, Haiti)
# Collaborators: Gesner Junior Deslandes, Roosevert Deslandes,
#                Sebastien Stephane Deslandes, Zendaya Christelle Deslandes
# Version: 78.7.0 (Global Shield API key displayed in sidebar)
...
# ====== LANGUAGE DICTIONARY ======
# (Full dictionary included; ensure all languages are present)
LANG = {
    "en": {
        "login_title": "Login",
...
def main_app():
    ...
    with st.sidebar:
        ...
        # ====== GLOBAL SHIELD STATUS (ADDED HERE) ======
