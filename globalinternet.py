...
# (Copy your full LANG dictionary from the original file – it is too long to include here,
#  but you have it. For completeness, I'll include a placeholder. You must paste your full dict.)
LANG = {
    "en": {
...
# IMPORTANT: Replace the above with your actual full LANG dictionary from your original app.py.
...
# ---- Helper functions for media embedding ----
